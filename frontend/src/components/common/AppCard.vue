  ...
  <div class="app-card">
    <div class="app-card__header">
      ...
      <div
        ...
        :class="`app-card__status--${application.status}`"
      >
    ...
    <div class="app-card__footer">
      ...
      <div class="app-card__actions">
        <button
          class="app-card__action-btn app-card__action-btn--preview"
          @click="$emit('preview', application)"
        >
          <span>👁</span>
        </button>
        <button
          class="app-card__action-btn app-card__action-btn--data"
          @click="$emit('data', application)"
        >
          <span>📊</span>
        </button>
        <button
          class="app-card__action-btn app-card__action-btn--edit"
        ...
        <button
          ...
          @click="$emit('delete', application._id)"
        >
          <span>🗑️</span>
        </button>
      </div>
...
<script setup lang="ts">
  ...
  defineEmits<{
    ...
    (e: "data", application: Application): void;
  }>();
